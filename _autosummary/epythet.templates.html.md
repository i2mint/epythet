...
| [`autosummary_module_rst`](#epythet.templates.autosummary_module_rst)   | submodules matching the ignore fragments are left out of the recursion, so no stub is generated (and no second import attempted) for tests/, scrap/, examples/. |
