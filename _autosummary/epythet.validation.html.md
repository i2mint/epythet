...
| [`ledger`](epythet.validation.ledger.html.md#module-epythet.validation.ledger)            | The artifact ledger: rule definitions (bundled YAML) and observations (user data dir). |
